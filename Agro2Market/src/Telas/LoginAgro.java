...
public class LoginAgro extends javax.swing.JFrame {
    ...
    public void RecuperarSenhaAP(String email)
    {               
        Agropecuario agp = marketDAO.encontrarAgropecuario(email);
        ...
        else
        {
            if(agp.isAtivo()==true)
            {
                JOptionPane.showMessageDialog(null,"Senha informada no momento do cadastro: "+agp.getSenha());
    ...
    private void initComponents() {
        ...
        setTitle("Login Agropecuario - agro2market");
        setResizable(false);
